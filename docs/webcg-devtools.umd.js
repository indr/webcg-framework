                      ...
                      return _c("tr", [
                        _c("td", { staticClass: "inline-edit" }, [
                          _c("input", {
                            ...
                            attrs: { type: "text" },
                            domProps: { value: row["key"] },
                            on: {
                              change: function($event) {
                                _vm.updateRecord(row);
                              },
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                                }
                                _vm.$set(row, "key", $event.target.value);
                              }
                            }
                          })
                        ]),
